...
<template>
    <div
        ...
        :title="!allowed ? `Requires ${requiredRole(permission)} role in ${businessName}` : undefined"
    >
        <div
            :class="!allowed ? 'cursor-not-allowed opacity-40 pointer-events-none select-none' : ''"
        ...
        >
            ...
            <svg
                ...
                fill="currentColor"
            >
                <path fill-rule="evenodd" d="M8 1a3 3 0 00-3 3v1H4a1 1 0 00-1 1v7a1 1 0 001 1h8a1 1 0 001-1V6a1 1 0 00-1-1H11V4a3 3 0 00-3-3zm0 1.5A1.5 1.5 0 019.5 4v1h-3V4A1.5 1.5 0 018 2.5zM8 9a1 1 0 110 2 1 1 0 010-2z" clip-rule="evenodd" />
            </svg>
