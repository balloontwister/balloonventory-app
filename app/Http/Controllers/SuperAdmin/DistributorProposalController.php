...
class DistributorProposalController extends Controller
{
    ...
    public function update(Request $request, DistributorCatalogProposal $proposal): RedirectResponse
    {
        $data = $request->validate([
            ...
            'proposed_theme_ids' => ['nullable', 'array'],
            'proposed_theme_ids.*' => ['string', 'exists:themes,id'],
            'proposed_print_color_ids' => ['nullable', 'array'],
            'proposed_print_color_ids.*' => ['string', 'exists:print_colors,id'],
            'proposed_print_side_ids' => ['nullable', 'array'],
            'proposed_print_side_ids.*' => ['string', 'exists:print_sides,id'],
